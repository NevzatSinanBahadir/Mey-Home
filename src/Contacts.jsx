...
const Contacts = () => {
  ...
  return (
    <div>
      ...
      <div className="map" style={{marginTop:'60px'}}>
        <iframe
      ...
      <div className="container text-center ">
          ...
          <div className="p-4 bg-white shadow-sm rounded-lg mx-auto hovercontact" >
          <h5 class="baslık">
...
<a className="" href="tel:905069293633">
 <div className="p-4 bg-white shadow-sm rounded-lg mx-auto mt-4 hovercontact" >
        <h5 class="baslık">
