...
import { KoseTakimiContext, TvUnitesiContext } from './productContext';
import Footer from './Footer';
import MobilyaNavbar from './MobilyaNavbar';
 
const TvUniteleriDetay = () => {
  ...
  useEffect(() => {
    ...
    let { id } = useParams();
    const [products] = useContext(TvUnitesiContext);
...
export default TvUniteleriDetay